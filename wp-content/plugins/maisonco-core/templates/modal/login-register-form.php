                ...
                <nav class="opal-tab-nav">
                    <ul>
                        <li class="tab-current"><a
                                href="#opal-tab-login"><span><?php esc_html_e( 'Login', 'maisonco-core' ) ?></span></a></li>
                        <li><a href="#opal-tab-register"><span><?php esc_html_e( 'Register', 'maisonco-core' ) ?></span></a></li>
                    </ul>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="username" type="text"
                                                   ...
                                                   placeholder="<?php esc_attr_e( 'Username', 'maisonco-core' ) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input name="password" type="password"
                                                   class="form-control" required
                                                   placeholder="<?php esc_attr_e( 'Password', 'maisonco-core' ) ?>">
                                        </div>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input name="remember"
                                                   type="checkbox"> <?php _e( 'Remember Me', 'maisonco-core' ) ?>
                                        </label>
                                    </div>
                                    <?php do_action( 'opalrealestate_captcha', 'login_form' ) ?>
                                    <button type="submit" data-button-action
                                            class="btn btn-primary btn-block"><?php _e( 'Login', 'maisonco-core' ) ?></button>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                   placeholder="<?php esc_html_e( 'Username', 'maisonco-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                   placeholder="<?php esc_html_e( 'Email', 'maisonco-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password"
                                                   placeholder="<?php esc_html_e( 'Password', 'maisonco-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password2"
                                                   placeholder="<?php esc_html_e( 'Confirm Password', 'maisonco-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <?php  do_action( 'opalrealestate_captcha', 'register_form' ) ?>
                                    <button type="submit" data-button-action
                                            class="btn btn-primary btn-block"><?php _e( 'Register', 'maisonco-core' ) ?></button>

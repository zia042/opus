...
class Osf_Template_Loader {
     ...
     * @throws Exception
     */
    public static function locate( $name, $plugin_dir = MAISONCO_CORE_PLUGIN_DIR ) {
        $template = '';
        $post_type = get_post_type();
     ...
     * @throws Exception
     */
    public static function get_template_part( $name, $args = array(), $plugin_dir = MAISONCO_CORE_PLUGIN_DIR ) {

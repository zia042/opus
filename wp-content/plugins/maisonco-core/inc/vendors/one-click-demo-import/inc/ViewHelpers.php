...
class ViewHelpers {
	...
	public static function plugin_header_output() {
		...
		<div class="ocdi__title-container">
			<h1 class="ocdi__title-container-title"><?php esc_html_e( 'One Click Demo Import', 'maisonco-core' ); ?></h1>
			<a href="https://ocdi.com/user-guide/" target="_blank" rel="noopener noreferrer">
				<img class="ocdi__title-container-icon" src="<?php echo esc_url( OCDI_URL . 'assets/images/icons/question-circle.svg' ); ?>" alt="<?php esc_attr_e( 'Questionmark icon', 'maisonco-core' ); ?>">
			</a>
		</div>
		<?php
	...
	public static function small_theme_card( $selected = null ) {
		...
		<div class="ocdi__card ocdi__card--theme">
			<div class="ocdi__card-content">
				<?php if ( $screenshot ) : ?>
					<div class="screenshot"><img src="<?php echo esc_url( $screenshot ); ?>" alt="<?php esc_attr_e( 'Theme screenshot', 'maisonco-core' ); ?>" /></div>
				<?php else : ?>

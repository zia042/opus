...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		...
		_doing_it_wrong( 'WP_REST_Controller::register_routes', sprintf( __( "Method '%s' must be overridden.", 'maisonco-core' ), __METHOD__ ), '4.7' );
	}
	...
	public function get_items_permissions_check( $request ) {
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass.", 'maisonco-core' ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	public function get_collection_params() {
		return array(
			...
			'page'                   => array(
				'description'        => __( 'Current page of the collection.', 'maisonco-core' ),
				'type'               => 'integer',
				'default'            => 1,
			...
			'per_page'               => array(
				'description'        => __( 'Maximum number of items to be returned in result set.', 'maisonco-core' ),
				'type'               => 'integer',
				'default'            => 10,
				'minimum'            => 1,
				'maximum'            => 100,
			...
			'search'                 => array(
				'description'        => __( 'Limit results to those matching a string.', 'maisonco-core' ),
				'type'               => 'string',
	...
	public function get_context_param( $args = array() ) {
		$param_details = array(
			'description'        => __( 'Scope under which the request is made; determines fields present in response.', 'maisonco-core' ),
			'type'               => 'string',

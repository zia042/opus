<div class="media-upload-block" data-name="<?php echo $field->args( '_id' ); ?>">
    <div class="property-media">
                ...
                <div id="property-thumbs-container">
                    ...
                    if (isset( $_GET['id'] ) && $_GET['id'] > 0) {
                        ...
                        foreach ($property_images as $image_id => $url) {
                            ...
                            echo '<a class="icon icon-delete" data-toggle="tooltip" title="' . __( 'Delete this image', 'maisonco-core' ) . '" data-property-id="' . intval( $post_id ) . '" data-attachment-id="' . intval( $image_id ) . '" href="javascript:;">';
                            echo '<i class="fa fa-trash-o"></i>';
                            echo '</a>';
                            echo '<a class="icon icon-fav icon-featured" data-toggle="tooltip" title="' . __( 'Set featured image', 'maisonco-core' ) . '" data-property-id="' . intval( $post_id ) . '" data-attachment-id="' . intval( $image_id ) . '" href="javascript:;">';
        ...
        <div id="drag-and-drop" class="media-drag-drop">
            <h4><i class="fa fa-cloud-upload"></i><?php esc_html_e( 'Drag and drop images here', 'maisonco-core' ); ?>
            </h4>
            <h4><?php esc_html_e( 'or', 'maisonco-core' ); ?></h4>
            <a id="select-images" href="javascript:;"
               class="btn btn-primary btn-3d"><?php esc_html_e( 'Select Images', 'maisonco-core' ); ?></a>
        </div>

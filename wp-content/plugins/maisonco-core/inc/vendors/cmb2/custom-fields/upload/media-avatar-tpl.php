<div class="my-avatar">
    ...
    <a id="select-profile-image" class="btn btn-primary btn-block btn-3d"
       href="javascript:;"><?php esc_html_e( 'Update Profile Picture', 'maisonco-core' ); ?></a>

    <span class="profile-img-info"><?php esc_html_e( '*minimum 270px x 270px', 'maisonco-core' ); ?><br/></span>
</div>
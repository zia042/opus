            ...
            <?php if ($files): ?>
                <?php foreach ($files as $image_id => $url): ?>
                    <div class="upload-item">
                        ...
                        echo '<a class="icon icon-delete" data-toggle="tooltip" title="' . __( 'Delete', 'maisonco-core' ) . '" data-post-id="' . intval( $post_id ) . '" data-attachment-id="' . intval( $image_id ) . '" href="javascript:;">';

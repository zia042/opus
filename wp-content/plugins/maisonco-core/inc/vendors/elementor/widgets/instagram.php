...
class OSF_Elementor_Instagram extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Instagram', 'maisonco-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_instagram',
			[
				'label' => __( 'Instagram Config', 'maisonco-core' ),
			]
		);
		...
		$this->add_control(
			'username',
			[
				'label'   => __( 'Username', 'maisonco-core' ),
		...
		$this->add_control(
			'number',
			[
				'label'   => __( 'Number of photos', 'maisonco-core' ),
		...
		$this->add_control(
			'size',
			[
				'label'   => __( 'Photo size', 'maisonco-core' ),
		...
		$this->add_control(
			'target',
			[
				'label'   => __( 'Open link in', 'maisonco-core' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '_blank',
				'options' => [
		...
		$this->add_control(
			'show_username',
			[
				'label' => __( 'Show Username', 'maisonco-core' ),
		...
		$this->add_control(
			'show_time',
			[
				'label' => __( 'Show Time', 'maisonco-core' ),
				'type'  => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'show_caption',
			[
				'label' => __( 'Show Caption', 'maisonco-core' ),
				'type'  => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'number_caption',
			[
				'label'     => __( 'Number of text caption', 'maisonco-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 15,
				'condition' => [
					'show_caption!' => '',
		...
		$this->add_control(
			'show_like',
			[
				'label' => __( 'Show Like', 'maisonco-core' ),
				'type'  => Controls_Manager::SWITCHER,
			]
		);
        $this->add_control(
            'show_comment',
            [
                'label' => __( 'Show Comment', 'maisonco-core' ),
                'type'  => Controls_Manager::SWITCHER,
                'condition' => [
                    'style' => 'insite',
                ],
			...
			if ( is_wp_error( $media_array ) ) {
				...
				foreach ( $media_array as $item ) {
                    ...
                    if ( $settings['show_like'] === 'yes' && $settings['style'] === 'insite' ) {
                        $result .= '<div class="instagram-like"><span>' . $this->otf_pretty_number( $item['likes'] ) . _n( ' like', ' likes', $item['likes'], 'maisonco-core' ) . '</span></div>';
                    }
                    if ( $settings['show_comment'] === 'yes' && $settings['style'] === 'insite' ) {
                        $result .= '<div class="instagram-comment"><span>' . $this->otf_pretty_number( $item['comments'] ) . _n( ' Comment',' Comments', $item['comments'] ,'maisonco-core' ) . '</span></div>';
                    }
					$result      .= '</div>';
	...
	private function otf_fnc_time( $time ) {
		...
		if ( $date > 7 ) {
			...
			return human_time_diff( $time, current_time( 'timestamp' ) ) . __( ' ago', 'maisonco-core' );
		}
	}
}

    ...
    public function render_content() {
        ...
        <div class="opal-control-image-select opal-control-footer" data-id="<?php echo esc_attr( $this->id ) ?>">
            <select <?php $this->link(); ?> title="">
                <option value="" disabled>---<?php esc_html_e('Select Footer', 'maisonco-core') ?>---</option>
                <?php
            ...
            <a href="#" target="_blank" data-link="<?php echo esc_url(admin_url('post.php?action=edit')) ?>" class="button button-primary" style="display: none;"><?php esc_html_e('Go to Footer builder', 'maisonco-core') ?></a>
        </div>
        <?php
    }
}

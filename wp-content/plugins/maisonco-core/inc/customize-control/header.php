    ...
    public function render_content() {
        ...
        <div class="otf-select-group-button">
            <select <?php $this->link(); ?> title="Header">
                <option value="" disabled>---<?php esc_html_e('Select Header', 'maisonco-core') ?>---</option>
                <?php
            ...
            <a href="#" target="_blank" data-link="<?php echo esc_url(admin_url('post.php?action=edit')) ?>" class="button button-primary" style="display: none;"><?php esc_html_e('Go to header builder', 'maisonco-core') ?></a>
        </div>
        <?php
    }
}

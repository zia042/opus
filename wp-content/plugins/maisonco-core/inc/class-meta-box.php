...
class OSF_Metabox {
    ...
    private function page_meta_box_tabs() {
        ...
        $cmb2 = new_cmb2_box(array(
            ...
            'title'         => __('Page Setting', 'maisonco-core'),
            ...
            'tabs'          => array(
                ...
                array(
                    ...
                    'title'  => __('Breadcrumb', 'maisonco-core'),
                    'fields' => array(
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Sidebar', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Sidebar Width', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Enable Page Title', 'maisonco-core'),
        ...
        if (osf_is_elementor_activated()) {
            $cmb2->add_field(array(
                'name'    => __('Enable Full Page', 'maisonco-core'),
        ...
        // Header
        $cmb2->add_field(array(
            'name'        => __('Enable Custom Header', 'maisonco-core'),
        ...
        $headers = wp_parse_args($this->get_post_type_data('header'), array(
            'default' => esc_html__('Default', 'maisonco-core'),
        ));
        $cmb2->add_field(array(
            'name'             => __('Layout', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Breadcrumb', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Heading Color', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Breadcrumb Text Color', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Breadcrumb Background Color', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'         => __('Breadcrumb Background', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Custom Footer', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Padding Top', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Enable Fixed Footer', 'maisonco-core'),
    ...
    private function header_builder($prefix = 'osf_') {
        $cmb2 = new_cmb2_box(array(
            ...
            'title'        => __('Header Settings', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable AbHeader Absolute', 'maisonco-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Background Color Mobile', 'maisonco-core'),

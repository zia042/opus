...
class OSF_Theme_Setup {
    ...
    public function add_settings_page() {
        ...
        $args = array(
            'id'           => 'api_key',
            'title'        => esc_html__( 'Settings', 'maisonco-core' ),
            'object_types' => array( 'options-page' ),
            'option_key'   => 'opal-settings',
            'tab_group'    => 'opal_settings',
            'tab_title'    => esc_html__( 'API Key', 'maisonco-core' ),
        ...
        $main_options->add_field( array(
            'name'        => esc_html__( 'Google API key', 'maisonco-core' ),
            'description' => sprintf( __( 'Please go to <a href="%s" target="_blank">Google developers page</a> to get API key.', 'maisonco-core' ), 'https://developers.google.com/maps/documentation/javascript/get-api-key' ),
            'id'          => 'api_key',
            'type'        => 'text',
        ) );
    }
    ...
    public function widgets_init() {
        register_sidebar(array(
            'name'          => esc_html__('Single Posts Sidebar', 'maisonco-core'),
            'id'            => 'sidebar-single-post',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on single posts.', 'maisonco-core'),
        ...
        register_sidebar(array(
            'name'          => esc_html__('Blog Sidebar', 'maisonco-core'),
            'id'            => 'sidebar-blog',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on blog posts and archive pages.', 'maisonco-core'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
        ...
        register_sidebar(array(
            'name'          => esc_html__('Page Sidebar', 'maisonco-core'),
            'id'            => 'sidebar-page',
            'description'   => esc_html__('Add widgets here to appear in your pages.', 'maisonco-core'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
    ...
    public function modal_login_register() {
        include_once trailingslashit(MAISONCO_CORE_PLUGIN_DIR) . 'templates/modal/login-register-form.php';
    }
    ...
    private function set_main_nav_content($items) {
        ...
        $items .= '<a data-search-toggle="toggle" data-target=".' . $id . '" class="fa fa-search" title="' . __("search", "maisonco-core") . '"></a>';

...
class OSF_Elementor_Google_Map extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Google Maps', 'maisonco-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __('Latitude', 'maisonco-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '21.030497',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'maisonco-core' ), 'https://www.google.com/maps')
            )
        ...
        $this->add_control(
            'longitude',
            array(
                'label'   => __('Longitude', 'maisonco-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '105.852510',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Ex: 21.030497, 105.852510. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'maisonco-core' ), 'https://www.google.com/maps')
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => [ 'size' => 500 ],
                'description' => esc_html__( 'Height of map.(px)', 'maisonco-core' ),
                'selectors' => [
        ...
        $this->add_control(
            'zoom',
            [
                'label' => __( 'Zoom Level', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'prevent_scroll',
            [
                'label' => __( 'Prevent Scroll', 'maisonco-core' ),
        ...
        $this->start_controls_section(
            'section_style_map',
            [
                'label' => __( 'Map Style', 'maisonco-core' ),
        ...
        $this->add_control(
            'all',
            [
                'label' => __( 'All Color', 'maisonco-core' ),
        ...
        $this->add_control(
            'water_color',
            [
                'label' => __( 'Water Color', 'maisonco-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            'water_lightness',
            [
                'label' => __( 'Water Lightness', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            'landscape_color',
            [
                'label' => __( 'Landscape Color', 'maisonco-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            'landscape_lightness',
            [
                'label' => __( 'Landscape Lightness', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Color', 'maisonco-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Lightness', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'poi_color',
            [
                'label' => __( 'Poi Color', 'maisonco-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            'poi_lightness',
            [
                'label' => __( 'Poi Lightness', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'road_color',
            [
                'label' => __( 'Road Color', 'maisonco-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            'road_lightness',
            [
                'label' => __( 'Road Lightness', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'transit_color',
            [
                'label' => __( 'Transit Color', 'maisonco-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            'transit_lightness',
            [
                'label' => __( 'Transit Lightness', 'maisonco-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
    ...
    private function data_style_title(){
        return array(
            ...
            'ultra_light' => __('Ultra Light', 'maisonco-core'),
            'shades_of_grey' => __('Shades of Grey', 'maisonco-core'),
            'blue_water' => __('Blue Water', 'maisonco-core'),
            'light_grey_and_blue' => __('Light Grey and Blue', 'maisonco-core'),
            'farma_gray' => __('Farma Gray', 'maisonco-core'),
            'community' => __('Community', 'maisonco-core'),
            'chilled' => __('Chilled', 'maisonco-core'),
            'customize' => __('Customize', 'maisonco-core')

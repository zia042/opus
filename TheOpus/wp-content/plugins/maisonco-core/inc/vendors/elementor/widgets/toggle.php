...
class OSF_Widget_Toggle extends Widget_Toggle {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control('tab_title', [
            ...
            'default'     => __('Toggle Title', 'maisonco-core'),
            'label_block' => true,
        ]);
        ...
        $repeater->add_control('tab_content', [
            ...
            'default'    => __('Toggle Content', 'maisonco-core'),
            'show_label' => false,
        ]);
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Toggle Items', 'maisonco-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Toggle #1', 'maisonco-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'maisonco-core'),
                    ],
                    [
                        'tab_title'   => __('Toggle #2', 'maisonco-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'maisonco-core'),
                    ],
                ],
        ...
        $this->add_control(
            'event_type',
            [
                'label'        => __('Event Type', 'maisonco-core'),
                'type'         => Controls_Manager::SELECT,
                'options'      => array(
                    'toggle'    => 'Toggle',
                    'accordion' => 'Accordion'
        ...
        $this->add_control(
            ...
            [
                ...
                'options'     => [
                    'left'  => [
                        'title' => __('Start', 'maisonco-core'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'right' => [
                        'title' => __('End', 'maisonco-core'),

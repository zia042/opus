			...
			<div class="ocdi__content-container-content--main">
				<div class="ocdi-create-content">
					<div class="ocdi-create-content-header">
						<h2><?php esc_html_e( 'Create Demo Content', 'maisonco-core' ); ?></h2>
						<p>
							<?php esc_html_e( 'Select which pre-built pages you want to import to use on your website. After that, all you need to do is customize the content to fit your needs and your page will be good to go.', 'maisonco-core' ); ?>
						</p>
					</div>
					<div class="ocdi-create-content-content">
						...
						<div class="ocdi-create-content-content-notice js-ocdi-create-content-install-plugins-notice">
							<p>
								<?php esc_html_e( 'The following plugins will be installed for free: ', 'maisonco-core' ); ?>
					...
					<div class="ocdi-create-content-footer">
						...
						<a href="#" class="button button-primary js-ocdi-create-content"><?php esc_html_e( 'Import' , 'maisonco-core' ); ?></a>
					</div>
				</div>
			</div>

...
if (!class_exists('CMB2_Tabs')) {
    ...
    class CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            wp_register_script('cmb-tabs', trailingslashit(MAISONCO_CORE_PLUGIN_URL) . 'inc/vendors/cmb2/libraries/js/tabs.js', array('jquery'), self::VERSION, true);
            wp_enqueue_script('cmb-tabs');

            wp_enqueue_style('cmb-tabs', trailingslashit(MAISONCO_CORE_PLUGIN_URL) . 'inc/vendors/cmb2/libraries/css/tabs.css', array(), self::VERSION);
        ...
        public function setup_dark_mode() {
            wp_enqueue_style('cmb-tabs-dark-mode', trailingslashit(MAISONCO_CORE_PLUGIN_URL) . 'inc/vendors/cmb2/libraries/css/dark-mode.css', array(), self::VERSION);

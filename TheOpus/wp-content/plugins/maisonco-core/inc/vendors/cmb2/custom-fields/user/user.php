...
class OSF_Field_Adduser {
    ...
    public static function render_map($field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object) {
        ...
        <div class="col-lg-12">
            <h5 class=""><?php _e( 'As an author, you can add other users to your office.', 'maisonco-core' ); ?></h5>
            <div>
                <p><?php _e( 'Add someone to your office, please enter extractly username in below input:', 'maisonco-core' ); ?></p>
                ...
                <div class="<?php echo apply_filters( 'opalrealestate_row_container_class', 'row opal-row' ); ?>">
                    ...
                    <div class="col-lg-4"><input name="search" class="button button-primary button-large pull-left"
                                                 id="publish" value="<?php _e( 'add', 'maisonco-core' ); ?>"
                                                 type="button">
                    </div>
                </div>
                    ...
                    <?php foreach ($users as $user_id): $user = get_user_by( 'id', $user_id );
                        ...
                        <div class="user-team">
                            ...
                            <div><span class="remove-user"
                                       data-alert="<?php _e( 'Are you sure to delete this', 'maisonco-core' ); ?>"><?php _e( 'Remove', 'maisonco-core' ); ?></span>
                            </div>
                        </div>
                    <?php endforeach; ?>
